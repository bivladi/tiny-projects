...
// Currency defines the code of currency
...
// ParseCurrency returns the currency associated to 
// a name and may return ErrInvalidCurrencyCode.
func ParceCurrency(code string) (Currency, error) {
	if len(code) != 3 {
